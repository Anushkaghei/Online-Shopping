...
def insert():
    read_query="insert into shop(itemname,price,modelno,dom,category) values(%s,%s,%s,%s,%s)"
    values=(name,price,model,date,category)
    cursor.execute(read_query,values)
    connection.commit()
    print("new record inserted")
    
def tablecreation():
    create_table= """create table shop(itemcode int auto_increment, 
                  itemname char(45) not null,
                  price char(40) not null,
                  modelno char(40) not null,
                  dom DATE,
...
def pay_method():
    ...
    tk.Radiobutton(pm, 
                  ...
                  variable=v, 
                  value=1,
                  command=debcred).pack(anchor=tk.W)
    ...
    tk.Radiobutton(pm, 
                  ...
                  variable=v, 
                  value=3,
                   command=giftcard).pack(anchor=tk.W)
    ...
    tk.Radiobutton(pm, 
                  ...
                  variable=v, 
                  value=4,
                   command=final).pack(anchor=tk.W)
...
def top1():
    ...
    query="SELECT * FROM SHOP WHERE CATEGORY=%s"
    value=category
